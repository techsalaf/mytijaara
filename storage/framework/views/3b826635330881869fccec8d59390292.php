<?php $__env->startSection('title',translate('Store Bulk Import')); ?>
    ...
    <div class="content container-fluid">
        <div class="page-header">
            <h1 class="page-header-title">
                ...
                <span>
                    <?php echo e(translate('messages.stores_bulk_import')); ?>
            ...
            <div class="card-body">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="export-steps-item-2 h-100">
                                ...
                                <ul class="m-0 pl-4">
                                    ...
                                    <li>
                                        <?php echo e(translate('You_can_get_module_id_and_zone_id_from_their_list,_please_input_the_right_ids.')); ?>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="export-steps-item-2 h-100">
                                ...
                                <ul class="m-0 pl-4">
                                    ...
                                    <li>
                                       <?php echo e(translate('After_uploading_stores_you_need_to_edit_them_and_set_stores`s_logo_and_cover.`s_path')); ?>

                                    </li>
                                    <li>
                                       <?php echo e(translate('You_can_upload_your_store_images_in_store_folder_from_gallery,_and_copy_image`s_path')); ?>

                                    </li>
                                    <li>
                                       <?php echo e(translate('Default_password_for_store_is_12345678.')); ?>
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        ...
                        <a href="<?php echo e(asset('public/assets/stores_bulk_format.xlsx')); ?>" download="" class="btn btn--primary btn-outline-primary"><?php echo e(translate('Template with Existing Data')); ?></a>
                        <a href="<?php echo e(asset('public/assets/stores_bulk_format_nodata.xlsx')); ?>" download="" class="btn btn--primary"><?php echo e(translate('Template without Data')); ?></a>
        ...
        <form class="product-form" id="import_form" action="<?php echo e(route('admin.store.bulk-import')); ?>" method="POST"
        ...
        <div class="card mt-2 rest-part">
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                        <h5 class="text-capitalize mb-3"><?php echo e(translate('Import_Stores_file')); ?></h5>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/admin-views/vendor/bulk-import.blade.php ENDPATH**/ ?>