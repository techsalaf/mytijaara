...
<head>
    ...
    <link rel="icon" type="image/x-icon"
        href="<?php echo e(\App\CentralLogics\Helpers::get_full_url('business', $logo?->value ?? '', $logo?->storage[0]?->value ?? 'public', 'favicon')); ?>">
    <!-- Font -->
...
<body class="footer-offset">
            ...
            <div class="col-md-12">
                <div id="loading" class="initial-hidden">
                    <div class="loader--inner">
                        <img width="80" src="<?php echo e(asset('public/assets/admin/img/loader.gif')); ?>" alt="image">
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php if(in_array($module_type, ['rental', 'ride-share'])): ?>
        <?php echo $__env->make("{$module_type}::admin.partials._sidebar_{$module_type}", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php else: ?>
    ...
    <main id="content" role="main" class="main pointer-event">
        ...
        <div class="d-none" id="text-validate-translate" data-required="<?php echo e(translate('this_field_is_required')); ?>"
                            ...
                            <div class="col-12">
                                <div class="text-center">
                                    <h2 class="update_notification_text">
                                        ...
                                        <?php echo e(translate('messages.You have new order, Check Please.')); ?>

                                    </h2>
                                    <hr>
                                    <button
                                        class="btn btn-primary check-order"><?php echo e(translate('messages.Ok, let me check')); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="max-349 mx-auto mb-20 mt-2">
                            ...
                            <div class="btn--container justify-content-center">
                                ...
                                <button type="button" id="toggle-ok-button"
                                    ...
                                    data-dismiss="modal"><?php echo e(translate('Yes')); ?></button>
                            </div>
                    ...
                    <div class="modal-body pb-5 pt-0">
                        <div class="max-349 mx-auto mb-20">
                            ...
                            <div class="mb-4 d-none" id="note-data">
                                <textarea class="form-control" placeholder="<?php echo e(translate('your_note_here')); ?>"
                                ...
                                <div id="hide-buttons">
                                    <div class="d-flex justify-content-center flex-wrap gap-3">
                                        <button data-dismiss="modal" id="cancel6_btn_text"
                                            class="btn btn--cancel min-w-120"><?php echo e(translate("Not_Now")); ?></button>
                                        <button type="button" id="new-dynamic-ok-button"
                                            class="btn btn-primary confirm-model min-w-120"><?php echo e(translate('Yes')); ?></button>
                                    </div>
                                </div>

                                <button data-dismiss="modal" type="button" id="new-dynamic-ok-button-show"
                                    class="btn btn--primary  d-none min-w-120"><?php echo e(translate('Okay')); ?></button>
                        ...
                        <div class="max-349 mx-auto">
                            ...
                            <div class="btn--container justify-content-center mt-3">
                                <button id="checkLater"
                                    class="btn btn--cancel min-w-120 fs-14 fw-semibold"><?php echo e(translate('Check Later')); ?></button>
                                <a href=""
                                    class="show-safety-alert-user-details btn btn-primary min-w-120 confirm-Toggle fs-14 fw-semibold"
                                    data-user-id="">
                                    <?php echo e(translate('View Alert')); ?>
        ...
        <script>
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('order') && $admin_order_notification && $order_notification_type == 'firebase'): ?>
                        ...
                        <?php if(addon_published_status('RideShare')): ?>
                            if (new_order_type === 'ride_request') {
                                document.querySelector('.update_notification_text').textContent = "<?php echo e(translate('messages.You have new ride request, Check Please.')); ?>";
                            }
                        <?php endif; ?>
                            if (admin_role_id === '1') {
                            playAudio();
            ...
            $(document).on('click', '.check-order', function () {
                if (new_order_type === 'parcel') {
                    ...
                    <?php if(addon_published_status('RideShare')): ?>
                        location.href = '<?php echo e(url('/')); ?>/admin/ride-share/ride/list/all?module_id=' + <?php echo e(\App\Models\Module::where('module_type', 'ride-share')->first()?->id); ?>;
                    <?php else: ?>
...
</html><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/layouts/admin/app.blade.php ENDPATH**/ ?>