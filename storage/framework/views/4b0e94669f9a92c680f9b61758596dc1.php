                        ...
                        <div class="item">
                            <div class="mw-353px mb-20 mx-auto">
                                <div class="text-center">
                                    <img src="<?php echo e(asset('/public/assets/admin/img/mail-config/slide-4.png')); ?>"
                                        alt="" class="mb-20">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/admin-views/business-settings/3rd_party/open_ai_config.blade.php ENDPATH**/ ?>