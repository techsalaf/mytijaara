...
<?php $__env->startSection('content'); ?>
        ...
        <div class="card">
            ...
            <div class="card-header py-2">
                <div class="search--button-wrapper">
                    <h4 class="card-title text-title"><?php echo e(translate('messages.stores_list')); ?> <span class="badge badge-soft-dark ml-2" id="itemCount"><?php echo e($stores->total()); ?></span></h4>
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    <a href="<?php echo e(route('admin.store.view', $store->id)); ?>" class="table-rest-info" alt="view store">
                                        <img class="img--60 rounded broder onerror-image" data-onerror-image="<?php echo e(asset('public/assets/admin/img/160x160/img1.jpg')); ?>"
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    ...
                                    href="<?php echo e(route('admin.store.edit',[$store['id'],'pending'=>1])); ?>" title="<?php echo e(translate('messages.edit_store')); ?>"><i class="tio-edit"></i>
                                    </a>
                                    ...
                                    <?php if(!isset($store->vendor->status)): ?>
                                        ...
                                        data-original-title="<?php echo e(translate('Reject')); ?>" data-toggle="modal" data-target="#confirmation-reason-btn<?php echo e($store->id); ?>"
    ...
    <div class="modal shedule-modal fade" id="confirmation-reason-btn<?php echo e($store->id); ?>" tabindex="-1"
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/admin-views/vendor/pending_requests.blade.php ENDPATH**/ ?>