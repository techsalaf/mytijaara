                                    ...
                                    <div class="d-none lang_form" id="<?php echo e($lang); ?>-form">
                                        <div class="form-group error-wrapper">
                                            ...
                                            <input type="text" name="name[]" id="<?php echo e($lang); ?>_name"
                                                class="form-control" placeholder="<?php echo e(translate('messages.store_name')); ?>">
                                        </div>
                                ...
                                <div class="error-wrapper">
                                    <div class="__custom-upload-img">
                                        ...
                                        <label class="form-label">
                                            <?php echo e(translate('logo')); ?> <span class="text--primary">(<?php echo e(translate('1:1')); ?>)
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3 my-0">
                                <div class="col-lg-4">
                                    <div class="form-group error-wrapper">
                                        <label class="input-label"
                                            for="choice_zones"><?php echo e(translate('messages.zone')); ?><span
                                                class="form-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="<?php echo e(translate('messages.select_zone_for_map')); ?>"><img
                                        ...
                                        <label class="input-label" for="latitude"><?php echo e(translate('messages.latitude')); ?>
                                            ...
                                            <span class="form-label-secondary" data-toggle="tooltip"
                                                ...
                                                <img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                    alt="<?php echo e(translate('messages.store_lat_lng_warning')); ?>"></span>
                                            <span class="form-label-secondary text-danger" data-toggle="tooltip"
                                                data-placement="right"
                                                data-original-title="<?php echo e(translate('messages.Required.')); ?>"> *
                                            </span>
                                    ...
                                    <div class="form-group mb-5 error-wrapper">
                                        <label class="input-label" for="longitude"><?php echo e(translate('messages.longitude')); ?>
                                            ...
                                            <span class="form-label-secondary" data-toggle="tooltip"
                                                data-placement="right"
                                                data-original-title="<?php echo e(translate('messages.store_lat_lng_warning')); ?>"><img
                                                    src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(\App\CentralLogics\Helpers::get_business_settings('map_api_key')); ?>&libraries=places,marker&callback=initMap&v=3.61">
    </script>
    ...
    <script>
        ...
        $('#vendor_form').on('submit', function(e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.store.store')); ?>',
                ...
                success: function(data) {
                    ...
                    if (data.errors) {
                        ...
                        toastr.success("<?php echo e(translate('store_added_successfully')); ?>", {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function() {
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/admin-views/vendor/index.blade.php ENDPATH**/ ?>