        ...
        <div class="modal-content bg-333333 border-0">
            ...
            <div class="modal-body px-3 pt-0 pb-2 bg-333333 rounded-bottom">
                ...
                <div class="d-none js-video-modal-unavailable rounded p-4 text-center" style="background:#444;">
                    <img src="<?php echo e(asset('public/assets/admin/img/video-placeholder.svg')); ?>" alt="Video unavailable" class="mb-3" style="width:48px;height:48px;opacity:.8;">
                    <p class="text-white mb-1 font-weight-semibold"><?php echo e(translate('Video unavailable')); ?></p>
                    <p class="text-white-50 fs-12 mb-0"><?php echo e(translate('This video link is invalid, unsupported, or currently not reachable')); ?>.</p>
                </div>
            </div>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/layouts/partials/_video-preview-modal.blade.php ENDPATH**/ ?>