        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="<?php echo e(asset('public/assets/admin/img/firebase_auth.png')); ?>" class="w--26" alt="">
                </span>
                <span>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="text-center my-5">
                        <img src="<?php echo e(asset('public/assets/admin/img/modal/bell.png')); ?>">
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/admin-views/business-settings/firebase-otp-index.blade.php ENDPATH**/ ?>