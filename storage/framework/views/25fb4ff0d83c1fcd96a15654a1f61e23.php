    ...
    <script>
        ...
        $(document).ready(function() {
            <?php if(count(json_decode($product['add_ons'], true)) > 0): ?>
                getStoreData(
                    '<?php echo e(url('/')); ?>/admin/store/get-addons?<?php $__currentLoopData = json_decode($product['add_ons'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>data[]=<?php echo e($addon); ?>& <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> store_id=',
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/admin-views/product/edit.blade.php ENDPATH**/ ?>