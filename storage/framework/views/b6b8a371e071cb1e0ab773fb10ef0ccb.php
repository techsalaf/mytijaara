                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('module')): ?>
                        <li
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li
                                    class="navbar-vertical-aside-has-menu <?php echo $__env->yieldContent('edit_module'); ?>  <?php echo e(Request::is('admin/business-settings/module') ? 'active' : ''); ?>">
                                    <a class="js-navbar-vertical-aside-menu-link nav-link"
                    ...
                    <?php if(\App\CentralLogics\Helpers::module_permission_check('settings')): ?>
                        ...
                        <?php if(addon_published_status('RideShare')): ?>
                            <li class="nav-item">
                                <small class="nav-subtitle"
                                    title="<?php echo e(translate('messages.ride_share_settings')); ?>"><?php echo e(translate('messages.ride_share_settings')); ?></small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/business-settings/ride-share*') || Request::is('admin/business-settings/ride-fare*') || Request::is('admin/business-settings/rider') ? 'active' : ''); ?>">
                                <a class="nav-link " href="<?php echo e(route('admin.business-settings.ride-fare.penalty')); ?>"
                                title="<?php echo e(translate('messages.additional_settings')); ?>">
                                    <span class="tio-settings nav-icon"></span>
                                    <span class="text-truncate"><?php echo e(translate('messages.additional_settings')); ?></span>
                                </a>
                            </li>
                            <li class="navbar-vertical-aside-has-menu <?php echo e(Request::is('admin/business-settings/safety-precaution/*') ? 'active' : ''); ?>">
                                <a class="nav-link " href="<?php echo e(route('admin.business-settings.safety-precaution.index', SAFETY_ALERT)); ?>"
                                title="<?php echo e(translate('messages.Safety_&_Precaution')); ?>">
                                    <span class="tio-settings nav-icon"></span>
                                    <span class="text-truncate"><?php echo e(translate('messages.Safety_&_Precaution')); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
