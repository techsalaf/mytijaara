            ...
            <div class="row align-items-center py-2">
                <div class="col-sm mb-2 mb-sm-0">
                    <div class="d-flex align-items-center">
                        <img class="onerror-image" data-onerror-image="<?php echo e(asset('/public/assets/admin/img/eshop.svg')); ?>" src="<?php echo e($mod->icon_full_url); ?>"
                        width="38" alt="img">
                ...
                <div class="row g-2" id="order_stats">
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/public/assets/admin/img/dashboard/stats/products.svg')); ?>" alt="dashboard/stats">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/public/assets/admin/img/dashboard/stats/orders.svg')); ?>" alt="dashboard/stats">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/public/assets/admin/img/dashboard/stats/stores.svg')); ?>" alt="dashboard/stats">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="__dashboard-card-2">
                            <img src="<?php echo e(asset('/public/assets/admin/img/dashboard/stats/customers.svg')); ?>" alt="dashboard/stats">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/admin-views/dashboard-ecommerce.blade.php ENDPATH**/ ?>