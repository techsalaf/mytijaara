        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="navbar-nav-wrap-content-right flex-grow-1 w-0">
                ...
                <ul class="navbar-nav align-items-center flex-row flex-grow-1 __navbar-nav">
                    ...
                    <?php if(\App\CentralLogics\Helpers::admin_can_access_workspace('users')): ?>
                    ...
                    <?php if(\App\CentralLogics\Helpers::admin_can_access_workspace('finance') || \App\CentralLogics\Helpers::admin_can_access_workspace('reports')): ?>
                    <li class="nav-item __nav-item">
                    ...
                    <?php if(\App\CentralLogics\Helpers::admin_can_access_workspace('settings')): ?>
                    <li class="nav-item __nav-item">
                        <a href="<?php echo e(\App\CentralLogics\Helpers::settings_workspace_landing_url()); ?>" id="tourb-3"
                    ...
                    <?php if(addon_published_status('RideShare') && \App\CentralLogics\Helpers::module_permission_check('fleet_view')): ?>
                        <li class="nav-item max-sm-m-0  mr-lg-3">
                            ...
                            <a id="v1-safety-link" class="btn btn-icon rounded-circle nav-msg-icon p-0 h-100 w-100 d-flex justify-content-center <?php if($latestSafetyAlert): ?> safety-alert-header-icon <?php endif; ?>"
                            <?php if($latestSafetyAlert): ?> data-user-id="<?php echo e($latestSafetyAlert->sent_by); ?>" <?php endif; ?>
                            href="<?php echo e(route('admin.ride-share.safety-alerts',['module_id'=>\App\Models\Module::where('module_type','ride-share')->first()->id ?? 0])); ?>">
                                <img src="<?php echo e(asset('/public/assets/admin/img/new-img/shield-check.svg')); ?>" class="d-block" alt="public/img">
                                <?php if($safety!=0): ?>
                                    <span class="btn-status btn-status-danger" id="v1-safety-badge"><?php echo e($safety); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <div class="nav-item __nav-item">
                        <a href="javascript:void(0)" class="__nav-link module--nav-icon" id="tourb-0">
                            ...
                            <?php else: ?>
                                <img src="<?php echo e(asset('/public/assets/admin/img/new-img/module-icon.svg')); ?>" class="flex-shrink-0"
                                     alt="public/img">
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/layouts/admin/partials/_header.blade.php ENDPATH**/ ?>