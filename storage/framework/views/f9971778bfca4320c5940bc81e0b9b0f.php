                ...
                <ul class="navbar-nav align-items-center flex-row flex-grow-1 __navbar-nav">
                    ...
                    <?php if(addon_published_status('RideShare')): ?>
                        <li class="nav-item max-sm-m-0  mr-lg-3">
                            ...
                            <a class="btn btn-icon rounded-circle nav-msg-icon p-0 h-100 w-100 d-flex justify-content-center <?php if($latestSafetyAlert): ?> safety-alert-header-icon <?php endif; ?>"
                            ...
                            href="<?php echo e(route('admin.ride-share.safety-alerts',['module_id'=>\App\Models\Module::where('module_type','ride-share')->first()->id ?? 0])); ?>">
                                ...
                                <?php if($safety!=0): ?>
                                    <span class="btn-status btn-status-danger"><?php echo e($safety); ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                    <?php endif; ?>
