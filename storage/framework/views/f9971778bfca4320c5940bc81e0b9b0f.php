...
<!-- <div class="toggle-tour">
    <a href="https://youtube.com/playlist?list=PLLFMbDpKMZBxgtX3n3rKJvO5tlU8-ae2Y" target="_blank"
       class="d-flex align-items-center gap-10px">
        <img src="<?php echo e(asset('public/assets/admin/img/tutorial.svg')); ?>" alt="">
        <span>
            <span class="text-capitalize"><?php echo e(translate('Tutorial')); ?></span>
        </span>
    </a>
    <div class="d-flex align-items-center gap-10px restart-Tour">
        <img src="<?php echo e(asset('public/assets/admin/img/tour.svg')); ?>" alt="">
        <span>
...
<div class="toggle-tour">
    ...
    <div class="d-flex flex-column">        
        ...
        <div class="tour-guide-items">
            <a href="https://youtube.com/playlist?list=PLLFMbDpKMZBxgtX3n3rKJvO5tlU8-ae2Y" target="_blank"
               class="d-flex align-items-center gap-10px">
                <span class="text-capitalize fs-14 text-title"><?php echo e(translate('Tutorial')); ?></span>
            </a>
        </div>    
