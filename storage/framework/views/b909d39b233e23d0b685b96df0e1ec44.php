            ...
            <div class="row g-2">
                                ...
                                <div class="lang_form" id="default-form">
                                    <div class="form-group error-wrapper">
                                        ...
                                        <input type="text" name="name[]" id="default_name" class="form-control"
                                            placeholder="<?php echo e(translate('messages.store_name')); ?>"
                                            value="<?php echo e($store->getRawOriginal('name')); ?>" required>
                                    ...
                                    <div class="form-group mb-0 error-wrapper">
                                        <label class="input-label"
                                            ...
                                            (<?php echo e(translate('messages.default')); ?>)  <span class="text-danger">*</span></label>
                                        <textarea type="text" name="address[]" placeholder="<?php echo e(translate('messages.store')); ?>" required
                                            class="form-control min-h-90px ckeditor"><?php echo e($store->getRawOriginal('address')); ?></textarea>
                                    ...
                                    <div class="d-none lang_form" id="<?php echo e($lang); ?>-form">
                                        <div class="form-group error-wrapper">
                                            ...
                                            <input type="text" name="name[]" id="<?php echo e($lang); ?>_name"
                                                class="form-control" value="<?php echo e($translate[$lang]['name'] ?? ''); ?>"
                                                placeholder="<?php echo e(translate('messages.store_name')); ?>">
                                        ...
                                        <div class="form-group mb-0 error-wrapper">
                                            ...
                                            <textarea type="text" name="address[]" placeholder="<?php echo e(translate('messages.store')); ?>"
                                                class="form-control min-h-90px ckeditor"><?php echo e($translate[$lang]['address'] ?? ''); ?></textarea>
                    ...
                    <div class="card shadow--card-2">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap flex-sm-nowrap __gap-12px">
                                <div class="__custom-upload-img mr-lg-5 error-wrapper">
                                    ...
                                    <label class="form-label">
                                        <?php echo e(translate('logo')); ?> <span
                                            class="text--primary">(<?php echo e(translate('1:1')); ?>)  <span class="text-danger">*</span></span>
                                    </label>
                                ...
                                <div class="__custom-upload-img error-wrapper">
                                    ...
                                    <?php ($icon = $icon->value ?? ''); ?>
                                    <label class="form-label">
                                        <?php echo e(translate('Store Cover')); ?> <span
                            ...
                            <small class="d-flex fs-10 justify-content-center">
                                        <span><?php echo e(translate(IMAGE_FORMAT.'. ' . 'Less Than 2MB')); ?></span>
                                    </small>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center">
                                <img class="mr-2 align-self-start w--20"
                                    src="<?php echo e(asset('public/assets/admin/img/resturant.png')); ?>" alt="instructions">
                            ...
                            <div class="row g-3 my-0">
                                <div class="col-md-12">
                                    <div class="position-relative">
                                        <label class="input-label"
                                            for="tax"><?php echo e(translate('Estimated Delivery Time ( Min & Maximum Time)')); ?>  <span class="text-danger">*</span></label>
                                        <div class="error-wrapper">
                                            <input type="text" id="time_view"
                                                value="<?php echo e($delivery_time_start); ?> to <?php echo e($delivery_time_end); ?> <?php echo e($delivery_time_type); ?>"
                                                    ...
                                                    <div class="floating--date-inner">
                                                        <div class="item error-wrapper">
                                                            ...
                                                            <input id="minimum_delivery_time" type="number"
                                                                ...
                                                                value="<?php echo e($delivery_time_start); ?>"
                                                        ...
                                                        <div class="item error-wrapper">
                                                            ...
                                                            <input id="maximum_delivery_time" type="number"
                                                                ...
                                                                value="<?php echo e($delivery_time_end); ?>"
                                                                class="form-control h--45px"
                                                        ...
                                                        <div class="item smaller">
                                                            <select name="delivery_time_type" id="delivery_time_type"
                                                                class="custom-select">
                                                                <option value="min"
                                                                    <?php echo e($delivery_time_type == 'min' ? 'selected' : ''); ?>>
                                                                    <?php echo e(translate('messages.minutes')); ?></option>
                                                                <option value="hours"
                                                                    <?php echo e($delivery_time_type == 'hours' ? 'selected' : ''); ?>>
                                                                    <?php echo e(translate('messages.hours')); ?></option>
                                                                <option value="days"
                                                                    <?php echo e($delivery_time_type == 'days' ? 'selected' : ''); ?>>
                                                                    <?php echo e(translate('messages.days')); ?></option>
                                                            </select>
                                                        </div>
                                                        <div class="item smaller">
                                                            <button type="button"
                                                                class="btn btn--primary delivery-time"><?php echo e(translate('done')); ?></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group error-wrapper">
                                        <label class="input-label" for="choice_zones"><?php echo e(translate('messages.zone')); ?>
                                            ...
                                            <span class="form-label-secondary" data-toggle="tooltip"
                                                ...
                                                data-original-title="<?php echo e(translate('messages.select_zone_for_map')); ?>">
                                                <img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                    alt="<?php echo e(translate('messages.select_zone_for_map')); ?>">
                                                ...
                                                <?php if(isset(auth('admin')->user()->zone_id)): ?>
                                                    <?php if(auth('admin')->user()->zone_id == $zone->id): ?>
                                                        <option value="<?php echo e($zone->id); ?>"
                                                            <?php echo e($store->zone_id == $zone->id ? 'selected' : ''); ?>>
                                    ...
                                    <div class="form-group error-wrapper">
                                        <label class="input-label" for="latitude"><?php echo e(translate('messages.latitude')); ?>
                                            ...
                                            <span class="form-label-secondary" data-toggle="tooltip"
                                                ...
                                                <img src="<?php echo e(asset('/public/assets/admin/img/info-circle.svg')); ?>"
                                                    alt="<?php echo e(translate('messages.store_lat_lng_warning')); ?>">
                                            </span> <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" id="latitude" name="latitude" class="form-control"
                                            placeholder="<?php echo e(translate('messages.Ex:')); ?> -94.22213"
                                            value="<?php echo e($store->latitude); ?>" required readonly>
                                    ...
                                    <div class="form-group mb-5 error-wrapper">
                                        ...
                                        <input type="text" name="longitude" class="form-control"
                                            ...
                                            value="<?php echo e($store->longitude); ?>" required readonly>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0 error-wrapper">
                                        <label class="input-label"
                                            for="f_name"><?php echo e(translate('messages.first_name')); ?>  <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0 error-wrapper">
                                        <label class="input-label"
                                            for="l_name"><?php echo e(translate('messages.last_name')); ?>  <span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-4 col-sm-6 error-wrapper">
                                    <div class="form-group mb-0">
                                        <label class="input-label"
                                            for="phone"><?php echo e(translate('messages.phone')); ?>  <span class="text-danger">*</span></label>
                                        <input type="tel" id="phone" name="phone" class="form-control"
                                            placeholder="<?php echo e(translate('messages.Ex:')); ?> 017********"
                                            value="<?php echo e($store->vendor->phone); ?>" required>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0 error-wrapper">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(translate('messages.email')); ?>  <span class="text-danger">*</span></label>
                                        <input type="email" name="email" class="form-control"
                                            placeholder="<?php echo e(translate('messages.Ex:')); ?> ex@example.com"
                                            value="<?php echo e($store->email); ?>" required>
                                    ...
                                    <div class="bg--secondary rounded p-20 h-100">
                                        <div class="form-group error-wrapper">
                                            ...
                                            <input type="text" name="tin"
                                                ...
                                                class="form-control" value="<?php echo e($store->tin); ?>">
                                        </div>
                                        <div class="form-group mb-0 error-wrapper">
                                            <label class="input-label mb-2 d-block title-clr fw-normal"
                                            ...
                                            <input type="date" name="tin_expire_date" class="form-control"
                                                value="<?php echo e($store->tin_expire_date); ?>">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="error-wrapper">
                                            ...
                                            <div class="d-flex justify-content-center" id="pdf-container">
                                                ...
                                                <div class="pdf-single" data-file-name="${file.name}"
                                                    data-file-url="<?php echo e($store->tin_certificate_image_full_url ?? asset('public/assets/admin/img/upload-cloud.png')); ?>">
                                                    <div class="pdf-frame">
                                                    ...
                                                    <div class="overlay">
                                                        <div class="pdf-info">
                                                            ...
                                                            <div class="file-name-wrapper">
                                                                <span
                                                                    class="file-name js-filename-truncate"><?php echo e($store->tin_certificate_image); ?></span>
                                                                <span
                ...
                <div class="col-lg-12">
                    <div class="btn--container justify-content-end">
                        ...
                        <button type="submit" id="submitButton" class="btn btn--primary"><?php echo e(request()->pending == 1 ? translate('Update_&_Approve') : translate('messages.submit')); ?></button>
                    </div>
                </div>
            </div>
        </form>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script  src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(\App\CentralLogics\Helpers::get_business_settings('map_api_key')); ?>&libraries=places,marker&callback=initMap&v=3.61">
    </script>
    <script>
        "use strict";
        ...
        const mapId = "<?php echo e(\App\CentralLogics\Helpers::get_business_settings('map_api_key')); ?>"
            ...
            function previewFile(inputSelector, previewImgSelector, textBoxSelector) {
                ...
                input.on('change', function() {
                    ...
                    if (validImageTypes.includes(fileType)) {
                        ...
                        imagePreview.attr('src', '<?php echo e(asset('public/assets/admin/img/file-icon.png')); ?>')
        ...
        $('#vendor_form').on('submit', function(e) {
            ...
            $.post({
                url: '<?php echo e(route('admin.store.update', [$store['id']])); ?>',
                ...
                success: function(data) {
                    ...
                    if (data.errors) {
                        ...
                        toastr.success("<?php echo e(translate('store_added_updated')); ?>", {
                            CloseButton: true,
                            ProgressBar: true
                        });
                        setTimeout(function() {
                            location.href =
                                "<?php echo e(route('admin.store.list')); ?>";
                        }, 1000);
                    }
                }
            });
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/admin-views/vendor/edit.blade.php ENDPATH**/ ?>