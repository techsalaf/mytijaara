                    ...
                    <div class="d-flex justify-content-between mt-5">
                        ...
                        <div class="form-group" id="forget-password" style="display: <?php echo e($role == 'admin' ? '' : 'none'); ?>;">
                            <div class="custom-control">
                                <span type="button" data-toggle="modal" class="text-primary text-hover--primary" data-target="#forgetPassModal"><?php echo e(translate('Forget Password')); ?>?</span>
                            </div>
                        </div>
                        <!-- End forget password -->
                        <div class="form-group" id="forget-password1" style="display: <?php echo e($role == 'vendor' ? '' : 'none'); ?>;">
                            <div class="custom-control">
                                <span type="button" data-toggle="modal" class="text-primary text-hover--primary" data-target="#forgetPassModal1"><?php echo e(translate('messages.Forget Password')); ?>?</span>
                            </div>
                        </div>
                        <!-- End forget password -->
                    </div>
