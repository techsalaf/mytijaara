<div id="sidebarMain" class="d-none">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <!-- End advertisement -->
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle"><?php echo e(translate('messages.Reels_Management')); ?></small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        <li class="navbar-vertical-aside-has-menu <?php echo $__env->yieldContent('reels_create'); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="<?php echo e(route('admin.reels.create')); ?>"
                               title="<?php echo e(translate('messages.Create_Reels')); ?>">
                                <i class="tio-video-camera-outlined nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(translate('messages.Create_Reels')); ?></span>
                            </a>
                        </li>
                        <li class="navbar-vertical-aside-has-menu <?php echo $__env->yieldContent('reels_list'); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="<?php echo e(route('admin.reels.index')); ?>"
                               title="<?php echo e(translate('messages.Reels_List')); ?>">
                                <i class="tio-format-bullets nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"><?php echo e(translate('messages.Reels_List')); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
    ...
    \App\CentralLogics\Helpers::module_permission_check('item')): ?>
                                        ...
                                        <li class="nav-item <?php echo e(Request::is('admin/item/requested/item/view/*') || Request::is('admin/item/new/item/list') || (Request::is('admin/item/edit/*') && strpos(request()->fullUrl(), 'temp_product=1') !== false  ) ? 'active' : ''); ?>">
                                            <a class="nav-link " href="<?php echo e(route('admin.item.approval_list')); ?>"
                                               title="<?php echo e(translate('messages.New_Item_Request')); ?>">
                                                <span class="tio-circle nav-indicator-icon"></span>
                                                <span class="text-truncate sidebar--badge-container">
                                                    <?php echo e(translate('messages.New_Item_Request')); ?>

                                                    <span class="badge badge-soft-success bg-light badge-pill ml-1">
                                                        <?php echo e(\App\Models\TempProduct::withoutGlobalScope(StoreScope::class)->module(Config::get('module.current_module_id'))->count()); ?>
                    ...
                    <li class="nav-item">
                        ...
                        <li class="navbar-vertical-aside-has-menu <?php echo $__env->yieldContent('new_store_request'); ?> <?php echo e(Request::is('admin/store/pending-requests') ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        <li class="navbar-vertical-aside-has-menu <?php echo $__env->yieldContent('store_update'); ?> <?php echo e(Request::is('admin/store/list')  ||  Request::is('admin/store/view/*')  ? 'active' : ''); ?>">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
...
<?php $__env->startPush('script_2'); ?>
   <script src="<?php echo e(asset('public/assets/admin/js/view-pages/sidebar.js')); ?>"></script>
<?php $__env->stopPush(); ?>
