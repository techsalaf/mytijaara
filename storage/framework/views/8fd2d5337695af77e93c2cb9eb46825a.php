                ...
                <div class="row gap__10 __customer-statistics-card-wrap-2">
                    <div class="col-sm-6">
                        <div class="__customer-statistics-card h-100">
                            <div class="title">
                                <img src="<?php echo e(asset('public/assets/admin/img/new-img/deliveryman/active.svg')); ?>"
                                    alt="new-img">
                        ...
                        <div class="__customer-statistics-card h-100 d-flex gap-3" style="--clr:#FF5A54">
                            <div>
                                <img width="48" height="48"
                                    src="<?php echo e(asset('public/assets/admin/img/new-img/deliveryman/newly.svg')); ?>" alt="new-img">
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="__customer-statistics-card h-100" style="--clr:#FF5A54">
                            <div class="title">
                                <img src="<?php echo e(asset('public/assets/admin/img/new-img/deliveryman/in-active.svg')); ?>"
                                    alt="new-img">
                    ...
                    <div class="row m-0">
                            ...
                            <a class="order--card h-100" href="#">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="<?php echo e(asset('public/assets/admin/img/dashboard/food/unassigned.svg')); ?>"
                        ...
                        <div class="col-12 p-0">
                            <a class="order--card h-100" href="#">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="<?php echo e(asset('public/assets/admin/img/dashboard/food/accepted.svg')); ?>"
                                            alt="dashboard" class="oder--card-icon">
                        ...
                        <div class="col-12 p-0">
                            <a class="order--card h-100" href="#">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                                        <img src="<?php echo e(asset('public/assets/admin/img/dashboard/food/out-for.svg')); ?>"
                                            alt="dashboard" class="oder--card-icon">
    ...
    function initialize() {
        ...
        deliveryMan.forEach(dm => {
            if (dm.lat) {
                ...
                activeIconContent.src = "<?php echo e(asset('public/assets/admin/img/delivery_boy_active.png')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/admin-views/dashboard-dispatch.blade.php ENDPATH**/ ?>