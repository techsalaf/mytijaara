                    ...
                    <table id="columnSearchDatatable"
                        ...
                        <thead class="thead-light border-0">
                            <tr>
                                ...
                                <th class="border-0 w--2"><?php echo e(translate('Module Name')); ?></th>
                        ...
                        <?php if(($module->module_type == 'rental' && addon_published_status('Rental') == 1) || $module->module_type != 'rental'): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <?php if( in_array($module['module_type'], ['parcel' , 'ride-share'])): ?>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/admin-views/module/index.blade.php ENDPATH**/ ?>