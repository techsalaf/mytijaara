                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group mb-0">
                                                    ...
                                                    <input id="business_name" type="text" name="business_name"
                                                        value="<?php echo e(\App\CentralLogics\Helpers::get_business_settings('business_name', false) ?? ''); ?>" class="form-control"
                                                ...
                                                <div class="form-group mb-0">
                                                    <label class="form-label"
                                                        ...
                                                        <span class="" data-toggle="tooltip" data-placement="right"
                                                            data-original-title="<?php echo e(translate('The physical location of your business')); ?>">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="input-label d-flex align-items-center gap-1">
                                                    ...
                                                    <span class="text-danger">*</span>
                                                        ...
                                                        <span class="" data-toggle="tooltip" data-placement="right"
                                                            data-original-title="<?php echo e(translate('Time zone impact for this system')); ?>">
                                                            <i class="tio-info text-muted"></i>
                                                        </span>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" name="additional_charge_name" class="form-control"
                                                    ...
                                                    placeholder="<?php echo e(translate('Ex:_Processing_Fee')); ?>" maxlength="50"
...
<div class="modal fade" id="maintenance-off-mode-modal">
    <div class="modal-dialog modal-dialog-centered status-warning-modal">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo e(route('admin.maintenance-mode')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="maintenance_mode_off" value="1">
                <div class="modal-body pb-5 pt-0">
                    <div class="max-349 mx-auto mb-20">
                        <div class="text-center">
                            <img width="80" src="<?php echo e(asset('public/assets/admin/img/modal/maintenance-off.png')); ?>" class="mb-20" alt="">
                            <h5 class="modal-title"><?php echo e(translate('Are you sure?')); ?></h5>
                        </div>
                        <div class="text-center">
                            <p><?php echo e(translate('Do you want to turn off Maintenance mode? Turning it off will activate all systems that were deactivated.')); ?></p>
                        </div>
                        <div class="btn--container justify-content-center">
                            <button data-dismiss="modal" type="button" class="btn btn--cancel min-w-120px"><?php echo e(translate('Cancel')); ?></button>
                            <button type="submit" class="btn btn--primary min-w-120px"><?php echo e(translate('Yes')); ?></button>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header pt-3">
                <h3><?php echo e(translate('Maintenance Mode')); ?></h3>
            ...
            <form method="post" action="<?php echo e(route('admin.maintenance-mode')); ?>" id="maintenance-mode-form">
                <?php echo csrf_field(); ?>
                <div class="modal-body pt-3 px-0">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-xxl-6 col-lg-4 col-md-5 col-sm-6">
                                    <div class="maintenance-mode-toggle-bar bg-white d-flex py-2 flex-wrap justify-content-between border rounded align-items-center y-2 px-3">
                                        ...
                                        <label class="toggle-switch toggle-switch-sm">
                                            <input type="checkbox" class="toggle-switch-input" id="maintenanceModalToggle" <?php echo e(isset($config) && $config ? 'checked' : ''); ?>>
                                            <span class="toggle-switch-label text mb-0">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                    ...
                    <div class="d-flex px-4 flex-column gap-4" id="maintenanceFormBody">
                        <div class="bg-light rounded p-20">
                            <div class="row mb-4">
                                <div class="col-xl-4">
                                    <h5 class="mb-2"><?php echo e(translate('Select System')); ?> <span class="text-danger">*</span></h5>
                                    <p class="fs-12"><?php echo e(translate('Select the systems you want to temporarily deactivate for maintenance')); ?></p>
                                </div>
                                <div class="col-xl-8">
                                            ...
                                            <div class="form-group m-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input system-checkbox" id="allSystem"
                                                        <?php echo e(in_array('vendor_panel', $selectedMaintenanceSystem) &&
                                                    ...
                                                    <label class="custom-control-label" for="allSystem">
                                                        <h5 class="mb-0 font-light lh-24 text-reset"><?php echo e(translate('All System')); ?></h5>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group m-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input system-checkbox" name="user_mobile_app" id="mobile_app"
                                                        <?php echo e(in_array('user_mobile_app', $selectedMaintenanceSystem) ? 'checked' : ''); ?>>
                                                    <label class="custom-control-label" for="mobile_app">
                                                        <h5 class="mb-0 font-light lh-24 text-reset"><?php echo e(translate('Mobile App')); ?></h5>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group m-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input system-checkbox" name="user_web_app" id="web_app"
                                                        <?php echo e(in_array('user_web_app', $selectedMaintenanceSystem) ? 'checked' : ''); ?>>
                                                    <label class="custom-control-label" for="web_app">
                                                        <h5 class="mb-0 font-light lh-24 text-reset"><?php echo e(translate('Web App')); ?></h5>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group m-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input system-checkbox" name="vendor_panel" id="vendor_panel"
                                                        <?php echo e(in_array('vendor_panel', $selectedMaintenanceSystem) ? 'checked' : ''); ?>>
                                                    <label class="custom-control-label" for="vendor_panel">
                                                        <h5 class="mb-0 font-light lh-24 text-reset"><?php echo e(translate('Vendor Panel')); ?></h5>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group m-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input system-checkbox" name="vendor_app" id="vendor_app"
                                                        <?php echo e(in_array('vendor_app', $selectedMaintenanceSystem) ? 'checked' : ''); ?>>
                                                    <label class="custom-control-label" for="vendor_app">
                                                        <h5 class="mb-0 font-light lh-24 text-reset"><?php echo e(translate('Vendor App')); ?></h5>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group m-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input system-checkbox" name="deliveryman_app" id="deliveryman_app"
                                                        <?php echo e(in_array('deliveryman_app', $selectedMaintenanceSystem) ? 'checked' : ''); ?>>
                                                    <label class="custom-control-label" for="deliveryman_app">
                                                        <h5 class="mb-0 font-light lh-24 text-reset"><?php echo e(translate('Deliveryman App')); ?></h5>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group m-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input system-checkbox" name="react_website" id="react_website"
                                                        <?php echo e(in_array('react_website', $selectedMaintenanceSystem) ? 'checked' : ''); ?>>
                                                    <label class="custom-control-label" for="react_website">
                                                        <h5 class="mb-0 font-light lh-24 text-reset"><?php echo e(translate('React Website')); ?></h5>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group m-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input system-checkbox" name="rider_app" id="rider_app"
                                                        <?php echo e(in_array('rider_app', $selectedMaintenanceSystem) ? 'checked' : ''); ?>>
                                                    <label class="custom-control-label" for="rider_app">
                                                        <h5 class="mb-0 font-light lh-24 text-reset"><?php echo e(translate('Rider App')); ?></h5>
                                                    </label>
                                                </div>
                                            </div>
                                            <?php endif; ?>
                                            <?php if(addon_published_status('Builder')): ?>
                                            <div class="form-group m-0">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input system-checkbox" name="vendor_storefront" id="vendor_storefront"
                                                        <?php echo e(in_array('vendor_storefront', $selectedMaintenanceSystem) ? 'checked' : ''); ?>>
                                                    <label class="custom-control-label" for="vendor_storefront">
                                                        <h5 class="mb-0 font-light lh-24 text-reset"><?php echo e(translate('Vendor Storefront')); ?></h5>
                                                    </label>
                                                </div>
                                            </div>
                                            <?php endif; ?>
                            ...
                            <div class="row mb-4">
                                <div class="col-xl-4">
                                    <h5 class="mb-2"><?php echo e(translate('Maintenance Date')); ?> & <?php echo e(translate('Time')); ?> <span class="text-danger">*</span></h5>
                                    <p class="fs-12"><?php echo e(translate('Choose the maintenance mode duration for your selected system.')); ?></p>
                                </div>
                                <div class="col-xl-8">
                                    <div class="d-flex flex-wrap gap-4 min-h-45px align-items-center bg-white border px-3 py-2 rounded mb-3">
                                        <div class="form-check form--check">
                                            <input class="form-check-input" type="radio" name="maintenance_duration"
                                                    <?php echo e(isset($selectedMaintenanceDuration['maintenance_duration']) && $selectedMaintenanceDuration['maintenance_duration'] == 'one_day' ? 'checked' : ''); ?>

                                                    value="one_day" id="one_day">
                                            <label class="form-check-label opacity-100" for="one_day"><?php echo e(translate('For 24 Hours')); ?></label>
                                        </div>
                                        <div class="form-check form--check">
                                            <input class="form-check-input" type="radio" name="maintenance_duration"
                                                    <?php echo e(isset($selectedMaintenanceDuration['maintenance_duration']) && $selectedMaintenanceDuration['maintenance_duration'] == 'one_week' ? 'checked' : ''); ?>

                                                    value="one_week" id="one_week">
                                            <label class="form-check-label opacity-100" for="one_week"><?php echo e(translate('For 1 Week')); ?></label>
                                        </div>
                                        <div class="form-check form--check">
                                            <input class="form-check-input" type="radio" name="maintenance_duration"
                                                    <?php echo e(isset($selectedMaintenanceDuration['maintenance_duration']) && $selectedMaintenanceDuration['maintenance_duration'] == 'until_change' ? 'checked' : ''); ?>

                                                    value="until_change" id="until_change">
                                            <label class="form-check-label opacity-100" for="until_change"><?php echo e(translate('Until I change')); ?></label>
                                        </div>
                                        <div class="form-check form--check">
                                            <input class="form-check-input" type="radio" name="maintenance_duration"
                                                    <?php echo e(isset($selectedMaintenanceDuration['maintenance_duration']) && $selectedMaintenanceDuration['maintenance_duration'] == 'customize' ? 'checked' : ''); ?>

                                                    value="customize" id="customize">
                                            <label class="form-check-label opacity-100" for="customize"><?php echo e(translate('Customize')); ?></label>
                                        </div>
                                    </div>
                                    <div class="">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <label class="form-label"><?php echo e(translate('Start Date')); ?> <span class="text-danger">*</span></label>
                                                <input type="datetime-local" class="form-control h-40" name="start_date" id="startDate"
                                                        value="<?php echo e(old('start_date', $selectedMaintenanceDuration['start_date'] ?? '')); ?>" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label"><?php echo e(translate('End Date')); ?> <span class="text-danger">*</span></label>
                                                <input type="datetime-local" class="form-control h-40" name="end_date" id="endDate"
                                                        value="<?php echo e(old('end_date', $selectedMaintenanceDuration['end_date'] ?? '')); ?>" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <small id="dateError" class="form-text text-danger" style="display: none;"><?php echo e(translate('Start date cannot be greater than end date.')); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                    <div class="border-top pt-4">
                                        <div class="row align-items-center">
                                            <div class="col-xl-4">
                                                <h5 class="mb-2"><?php echo e(translate('Maintenance Massage')); ?></h5>
                                                <p><?php echo e(translate('Select & type what massage you want to see your selected system when maintenance mode is active.')); ?></p>
                                            </div>
                                            <div class="col-xl-8">
                                                <div class="">
                                                    <div class="mb-20">
                                                        <label class="form-label"><?php echo e(translate('Show Contact Info')); ?></label>
                                                            ...
                                                            <div class="form-group m-0">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input" name="business_number" id="business_number"
                                                                        <?php echo e(isset($selectedMaintenanceMessage['business_number']) && $selectedMaintenanceMessage['business_number'] == 1 ? 'checked' : ''); ?>>
                                                                    <label class="custom-control-label" for="business_number">
                                                                        <h5 class="mb-0 font-light lh-24 text-reset"><?php echo e(translate('Business Number')); ?></h5>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                            <div class="form-group m-0">
                                                                <div class="custom-control custom-checkbox">
                                                                    <input type="checkbox" class="custom-control-input" name="business_email" id="business_email"
                                                                        <?php echo e(isset($selectedMaintenanceMessage['business_email']) && $selectedMaintenanceMessage['business_email'] == 1 ? 'checked' : ''); ?>>
                                                                    <label class="custom-control-label" for="business_email">
                                                                        <h5 class="mb-0 font-light lh-24 text-reset"><?php echo e(translate('Business Email')); ?></h5>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <label class="form-label"><?php echo e(translate('Message Title')); ?> <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control h-40" name="maintenance_message" id="maintenance_message"
                                                            placeholder="<?php echo e(translate('We are Working On Something Special!')); ?>"
                                                            maxlength="100" value="<?php echo e($selectedMaintenanceMessage['maintenance_message'] ?? ''); ?>">
                                                        <div class="d-flex justify-content-end">
                                                            <span class="text-counting text-body-light text-right d-block mt-1">0/100</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group mt-3">
                                                        <label class="form-label"><?php echo e(translate('Message Body')); ?> <span class="text-danger">*</span></label>
                                                        <div class="character-count">
                                                            <textarea class="form-control character-count-field h-40" rows="1" name="message_body" id="message_body" maxlength="100" placeholder="<?php echo e(translate('We are Working On Something Special!')); ?>"><?php echo e($selectedMaintenanceMessage['message_body'] ?? ''); ?></textarea>
                                                            <div class="d-flex justify-content-end">
                                                                <span class="text-counting text-body-light text-right d-block mt-1">0/100</span>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="mb-0">
                                        <button class="advance-button font-weight-medium outline-0 shadow-none d-block mb-3 btn p-0 text-underline text--primary collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            <span class="advance-text">
                                                <?php echo e(translate('Advanced Settings')); ?>
                ...
                <div class="modal-footer">
                    <div class="btn--container justify-content-end py-3">
                        <button type="reset" class="btn btn--reset min-w-120px" data-dismiss="modal"><?php echo e(translate('cancel')); ?></button>
                        <button type="<?php echo e(getEnvMode() != 'demo' ? 'submit' : 'button'); ?>" class="btn btn--primary <?php echo e(getEnvMode() == 'demo' ? 'demo_check' : ''); ?> min-w-120px" id="submit">
...
<script>
    ...
    const maintenanceIsOn = <?php echo e(isset($config) && $config ? 'true' : 'false'); ?>;
    ...
    $(document).on('click', '.demo_check', function (e) {
        e.preventDefault();
        toastr.warning('<?php echo e(translate('Sorry! You can not enable maintenance mode in demo!')); ?>');
    });
    ...
    $('#maintenance-mode-form').on('submit', function (e) {
        if ($('.system-checkbox').not('#allSystem').filter(':checked').length === 0) {
            e.preventDefault();
            toastr.error('<?php echo e(translate("Please select at least one system")); ?>');
            return false;
        }
        if ($('input[name="maintenance_duration"]:checked').length === 0) {
            e.preventDefault();
            toastr.error('<?php echo e(translate("Please select a maintenance date & time duration")); ?>');
            return false;
        }
    });
</script>
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mytijaara\resources\views/admin-views/business-settings/settings/business-index.blade.php ENDPATH**/ ?>