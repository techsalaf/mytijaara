                            ...
                            <input type="text" name="key" value="promotional_banner"  hidden>
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <label class="__upload-img aspect-4-1 m-auto d-block upload-zone" data-preview="parcel_promo_edit_image" data-input="parcel_promo_edit_input">
                                                <div class="img">
                                                    <img id="parcel_promo_edit_image" class="onerror-image"
                                                    ...
                                                    <input type="file" name="image" id="parcel_promo_edit_input" hidden>
