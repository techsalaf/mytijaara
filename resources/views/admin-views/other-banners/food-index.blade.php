                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <label class="__upload-img aspect-235-375 m-auto d-block position-relative upload-zone" data-preview="food_best_reviewed_img" data-input="food_best_reviewed_input">
                                    <div class="img">
                                        <img id="food_best_reviewed_img" class="onerror-image"
                                    ...
                                    <div class="">
                                        <input type="file" name="image" id="food_best_reviewed_input" hidden>
                                    </div>
