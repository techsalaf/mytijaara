                    ...
                    <div class="row g-3">
                        <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                            <div>
                                ...
                                <p class="mb-0 fs-12">
                                    {{ translate('Turning on the Maintenance Mode will temporarily deactivate your selected systems as of your chosen date and time.') }}
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div>
                                ...
                                <p class="mb-0 fs-12">
                                    {{ translate('Here you setup all your business information.') }}
                                </p>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="row g-3">
                                    <div class="col-xxl-9 col-lg-8 col-md-7 col-sm-6">
                                        <div>
                                            ...
                                            <p class="mb-0 fs-12">
                                                {{ translate('By switching this feature ON, Customer needs to pay the amount you set. ') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-xxl-3 col-lg-4 col-md-5 col-sm-6">
                ...
                <div class="max-349 mx-auto mb-20">
                    <div>
                        ...
                        <div class="text-center">
                            ...
                            <div>
                                <p>{{ translate('If_you_enable_this_currency,_you_must_activate_at_least_one_digital_payment_method_that_supports_this_currency._Otherwise_customers_cannot_pay_via_digital_payments_from_the_app_and_websites._And_Also_restaurants_cannot_pay_you_digitally') }}
                                </p>
                            </div>
                        </div>
