                    ...
                    <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label class="upload-img-3 m-0 upload-zone" data-preview="flutter_criteria_edit_image" data-input="flutter_criteria_edit_input">
                                        <div class="position-relative">
                                        <div class="img">
                                            <img id="flutter_criteria_edit_image"
                                          ...
                                          <input type="file" name="image" id="flutter_criteria_edit_input" hidden>
