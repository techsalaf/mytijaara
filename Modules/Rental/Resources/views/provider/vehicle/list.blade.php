            ...
            <div class="card-header py-2">
                <div class="search--button-wrapper">
                    ...
                    <div class="hs-unfold mr-2">
                        ...
                        <div id="usersExportDropdown"
                            ...
                            <a id="export-excel" class="dropdown-item"
                               href="{{ route('vendor.vehicle.export', ['type' => 'excel', request()->getQueryString()]) }}">
                            ...
                            <a id="export-csv" class="dropdown-item"
                               href="{{ route('vendor.vehicle.export', ['type' => 'csv', request()->getQueryString()]) }}">
                                <img class="avatar avatar-xss avatar-4by3 mr-2"
                    ...
                    <a class="btn btn--primary font-weight-bold float-right mr-2 mb-0"
                       href="{{ route('vendor.vehicle.create') }}">{{ translate('messages.new_vehicle') }}
                    </a>
                </div>
            </div>
            <!-- End Header -->
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn--container justify-content-center">
                                    <a class="btn action-btn btn--primary btn-outline-primary" href="{{ route('vendor.vehicle.details', $vehicle->id)}}?vehicle_list=true"
                                       title="{{ translate('messages.view') }}"><i class="tio-visible-outlined"></i>
                                    </a>
                                    <a class="btn action-btn btn-outline-primary" href="{{ route('vendor.vehicle.edit', $vehicle->id)}}"
