    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                    ...
                    <div class="card-body">
                        <div class="maintainance-mode-toggle-bar d-flex flex-wrap justify-content-between border rounded align-items-center p-2">
                            <h5 class="text-capitalize m-0 text--primary pl-2">
                                {{translate('Send_Mail_on_Suspend_a_Provider')}}
                                <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_Admin_suspends_a_provider’s_,_the_provider_will_get_a_suspend_mail_from_the_system.')}}">
                                    <img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}" alt="{{ translate('messages.Send_Mail_on_Suspend_a_Provider') }}">
                                </span>
                            </h5>
                            <label class="toggle-switch toggle-switch-sm">
                                ...
                                data-title-on="{{translate('Want_to_enable_Provider_suspend_mail?')}}"
                                data-title-off="{{translate('Want_to_disable_Provider_suspend_mail?')}}"
                                data-text-on="<p>{{translate('If_enabled,_Provider_will_receive_an_email_for_account_suspension.')}}</p>"
                                data-text-off="<p>{{translate('If_disabled,_Provider_will_not_receive_an_email_for_account_suspension.')}}</p>"
                        ...
                        <form action="{{route('admin.business-settings.rental-email-status',['provider','suspend',$mail_status == '1'?0:1])}}" method="get" id="mail-status_form">
                        </form>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.business-settings.rental-email-setup', ['provider','suspend']) }}" method="POST" enctype="multipart/form-data">
                    @csrf
