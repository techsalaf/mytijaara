    ...
    <div class="content container-fluid">
        ...
        <div class="row g-3">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.rental.notification.store')}}" method="post" enctype="multipart/form-data" id="notification">
                            @csrf
                            <div class="row gy-3">
                                <div class="col-lg-6">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-0">
                                                ...
                                                <select name="target" class="form-control js-select2-custom" id="target" data-placeholder="{{translate('messages.select_target')}}" required>
                                                    <option value="customer">{{translate('messages.customer')}}</option>
                                                    <option value="store">{{translate('messages.Provider')}}</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-12">
                        ...
                        <div class="search--button-wrapper">
                            ...
                            <div class="hs-unfold mr-2">
                                ...
                                <div id="usersExportDropdown"
                                    ...
                                    <a id="export-excel" class="dropdown-item" href="{{route('admin.rental.notification.export', ['type'=>'excel' , request()->getQueryString()])}}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                                            src="{{ asset('public/assets/admin') }}/svg/components/excel.svg"
                                            alt="Image Description">
                                        {{ translate('messages.excel') }}
                                    </a>
                                    <a id="export-csv" class="dropdown-item" href="{{route('admin.rental.notification.export', ['type'=>'csv', request()->getQueryString()])}}">
                                        <img class="avatar avatar-xss avatar-4by3 mr-2"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="toggle-switch toggle-switch-sm" for="stocksCheckbox{{$notification->id}}">
                                            <input type="checkbox" data-url="{{route('admin.rental.notification.status',[$notification['id'],$notification->status?0:1])}}" class="toggle-switch-input redirect-url" id="stocksCheckbox{{$notification->id}}" {{$notification->status?'checked':''}} hidden>
                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            ...
                                            href="{{route('admin.rental.notification.edit',[$notification['id']])}}" title="{{translate('messages.edit_notification')}}"><i class="tio-edit"></i>
                                            </a>
                                            ...
                                            <form action="{{route('admin.rental.notification.delete',[$notification['id']])}}" method="post" id="notification-{{$notification['id']}}">
                                                @csrf @method('delete')
                                            </form>
                                        </div>
                                    </td>
