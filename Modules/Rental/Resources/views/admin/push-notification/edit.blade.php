...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{route('admin.rental.notification.update',[$notification['id']])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
                        <div class="col-lg-6">
                            <div class="row g-2">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="target" class="form-control" id="target" data-placeholder="{{translate('messages.select_target')}}" required>
                                            ...
                                            <option value="store" {{$notification->target=='provider'?'selected':''}}>{{translate('messages.provider')}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12">
